...
export const GetList = async (ctx, next) => {
  try {
    ...
    for (let i = 0; i < specialtys.rows.length; i++) {
      ...
      //     return parseFloat(l)
      //   })
      //   const distance = getFlatternDistance(location[1], location[0], specialtys.rows[i].restaurant.location_x, specialtys.rows[i].restaurant.location_y) ? getFlatternDistance(location[1], location[0], specialtys.rows[i].restaurant.location_x, specialtys.rows[i].restaurant.location_y) : 0
