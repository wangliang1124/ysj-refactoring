  ...
  <div class="shopcart">
    <div class="shopcart-wrapper">
      <div class="shopcart-content-wrapper">
        <span class="icon"  @touchstart="toggleList">
        ...
        <span class="pay" :class="{highlight:totalPrice>0}" @touchstart="showPay">去结算</span>
      </div>
      <transition name="fold">
        <div class="shopcart-list" v-show="showList">
          <div class="list-header">
            <span class="title">购物车</span><span class="empty" @touchstart="emptyShopcart">清空</span>
          </div>
    ...
    <div class="pay-info" v-show="showPayInfo">
      ...
      <div class="pay-info-footer">
        <div class="close" @touchstart="closeInfo"><span>×</span></div>
      </div>
    </div>
    <transition name="fade">
      <div class="list-mask" @touchstart="hideList" v-show="showMask"></div>
    </transition>
  </div>
</template>
<script>
    ...
    .shopcart-wrapper
      ...
      .shopcart-content-wrapper
        ...
        .icon
          ...
          .iconfont
            font-dpr(28px)
            color: rgba(214, 108, 120, 0.3)
            &.highlight
              color: rgba(214, 108, 120, 0.5)
          .num
            position: absolute
            right: 20px
            top: 12px
